 ...
 * 
 */
/*/* Type for providing special settings for the hosted server #1#
...
/* Type for holding our SearchResult and exposing the needed properties to blueprints#1#
USTRUCT(BlueprintType)
 ...
 */
UCLASS()
class NETWORKPLUG_API UNetWorkSystem : public UObject
{
	GENERATED_BODY()
public:
	UNetWorkSystem(/*const FObjectInitializer& ObjectInitializer*/);
